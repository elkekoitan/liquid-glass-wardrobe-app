...
class _Animation {
  ...
  Duration get fast =>
      Duration(milliseconds: AppSpacing.animationFast); // 200ms
  Duration get medium =>
      Duration(milliseconds: AppSpacing.animationMedium); // 300ms
  Duration get slow =>
      Duration(milliseconds: AppSpacing.animationSlow); // 500ms
  Duration get veryClose =>
      Duration(milliseconds: AppSpacing.animationVeryClose); // 1000ms

  // Glass specific
  Duration get liquidAnimation =>
      Duration(milliseconds: AppSpacing.liquidAnimationDuration); // 800ms
  Duration get glassTransition =>
      Duration(milliseconds: AppSpacing.glassTransitionDuration); // 250ms
}
